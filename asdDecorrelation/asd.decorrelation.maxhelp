...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 277.0, 597.0, 80.0, 13.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"parameter_enable" : 1,
					"patching_rect" : [ 140.0, 491.0, 69.0, 77.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 236.0, 180.0, 71.0, 19.0 ],
					"text" : "prepend mode"
				}
...
, 			{
				"box" : 				{
					...
					"fontsize" : 14.0,
					"id" : "obj-2",
					"items" : [ "Direct", "Delay", ",", "Filtered", "Delay" ],
					"maxclass" : "umenu",
					"numinlets" : 1,
					"numoutlets" : 3,
					"outlettype" : [ "int", "", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 236.0, 150.0, 135.0, 24.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 56.0, 139.0, 167.0, 24.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 7.0, 48.0, 244.0, 18.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 7.0, 48.0, 244.0, 18.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 5.0, 253.0, 172.0, 22.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 7.0, 218.0, 179.0, 22.0 ],
					"text" : "2. Decorrelation balance"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 6.0, 75.0, 333.0, 22.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 6.0, 75.0, 282.0, 22.0 ],
					"text" : "1. Set source and de-correlation settings"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 0,
					"patching_rect" : [ 11.5, 563.0, 34.0, 34.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 333.0, 300.0, 56.0, 56.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 85.0, 119.0, 145.0, 24.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 56.0, 108.0, 167.0, 24.0 ],
					"text" : "source.maxpat"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 186.5, 210.0, 167.0, 24.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 56.0, 165.0, 167.0, 24.0 ],
					"text" : "asd.decorrelation.maxpat"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 281.0, 389.0, 91.0, 19.0 ],
					"text" : "expr (127 - $i1)"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 140.0, 296.0, 50.0, 19.0 ],
					"text" : "loadbang"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 186.5, 420.0, 74.0, 29.0 ],
					"text" : "pan2X.maxpat 100"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "signal", "signal" ],
					"patching_rect" : [ 85.0, 420.0, 74.0, 29.0 ],
					"text" : "pan2X.maxpat 100"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 0,
					"patching_rect" : [ 140.0, 583.0, 64.0, 19.0 ],
					"text" : "dac~"
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 94.5, 185.0, 196.0, 185.0 ],
					"order" : 0,
					"source" : [ "obj-16", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 94.5, 264.0, 94.5, 264.0 ],
					"order" : 1,
					"source" : [ "obj-16", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 285.5, 340.0, 149.5, 340.0 ],
					"source" : [ "obj-22", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-25", 0 ],
					"midpoints" : [ 219.5, 340.0, 149.5, 340.0 ],
					"source" : [ "obj-23", 0 ]
				}
